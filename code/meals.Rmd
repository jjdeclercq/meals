...
```{r}
# Get df of recipes
meals <- read.csv("/Users/joshvumc/Dropbox/meal_planning/DATA/Meals - Sheet1.csv")
...
ingredients <- read.csv("/Users/joshvumc/Dropbox/meal_planning/DATA/ingredients.csv")
...
made_menu <- make_menu(recipes_expand, ingredients, meals)
  write.csv(made_menu, "/Users/joshvumc/Dropbox/meal_planning/DATA/jd_recipes.csv")
